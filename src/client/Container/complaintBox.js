                    ...
                    <form className="complaint-form">
                        <div className="form-group">
                            ...
                            <input type="text" name="title" id="title" className="form-control"
                                   onChange={this.eventHandler} placeholder="Enter Title for Complaint" required/>
                        </div>
                        ...
                        {/*<input type="submit" className="btn btn-success complaint-btn" value="Submit"*/}
                               {/*onClick={this.createBuzzOnSubmit}/>*/}
                        <RaisedButton label="Secondary" secondary={true} style={styles.submitButton}
                                      onClick={this.createBuzzOnSubmit} />
                    </form>
                </div>
